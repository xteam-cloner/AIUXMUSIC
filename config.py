...
BOT_USERNAME = getenv("BOT_USERNAME" , "xteam_musicbot")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-100238513872"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "xteammusic")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/JIYOXC/AIUXMUSIC")
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/xteam_cloner")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/xteam_cloner")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/JIYOXC/AIUXMUSIC")
...
DURATION_LIMIT = int(time_to_seconds(f"{DURATION_LIMIT_MIN}:300"))
